...
const Contact: React.FC = () => {
  ...
  return (
    <>
      ...
      <Page>
        <section className="relative py-28 xl:py-56 px-5 w-full">
          <div className="relative max-w-[100rem] mx-auto my-1 ">
            <div className="hero-inner relative py-28 xl:py-56  w-full">
