                    ...
                    <div className="w-full flex justify-start md:flex-row">
                      <div className="subtitles">
                        <p className="text-gray-primario">
                          ...
                          estrategias para proyectos digitales impactantes. Soy
                          un apasionado de la tecnología y la creatividad, con
                          amplia experiencia en herramientas y lenguajes como:
                        </p>
                      </div>
                    </div>
                  </motion.div>
                    ...
                    <div className="w-full flex justify-start md:flex-row">
                      <div className="subtitles">
                        <p className="text-gray-primario">
                          ...
                          Internet SC) y de Community Manager (TEINUX). Además,
                          he completado un curso de diseño UX de OpenClassRooms.
